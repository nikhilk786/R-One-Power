...
function Faq() {
  return (
    <div className="p-6 md:p-20">
      {/*Headings*/}
      <div>
        <p className="text-4xl md:text-5xl font-poppins font-bold mb-6 text-center">
          Frequently Asked <span className="text-[#1E88E5]">Questions</span>
        </p>
        <p className="font-inter text-lg text-center text-[#717A75]">
      ...
      <div>
        ...
        <div className="max-w-8xl mx-auto lg:mx-6 px-4 py-16">
          <div className="grid grid-cols-1 lg:grid-cols-[2fr_3fr] gap-10 items-start">
            ...
            {/* Left - Image */}
            <div className="relative w-full h-[350px] lg:h-full rounded-lg overflow-hidden hidden lg:block">
              <Image
                src={Solar}
                alt="Solar FAQ"
                fill
